...
::: info You are reading the documentation for [Vben Admin Naive](https://github.com/Ducr/vue-vben-admin-naive) version `5.5.9`! This is a Naive UI version SPA independently split from Vue Vben Admin v5.5.9.
