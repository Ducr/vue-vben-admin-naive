# About Vue Vben Admin Naive

::: info You are reading the documentation for [Vue Vben Admin Naive](https://github.com/Ducr/vue-vben-admin-naive) version `5.0`!
...
- [Vue Vben Admin Naive](https://github.com/Ducr/vue-vben-admin-naive) is still being actively updated. Contributions are welcome to help maintain and improve the project, aiming to create a better mid- to backend solution.
