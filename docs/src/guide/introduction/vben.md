...
::: info 你正在阅读的是 [Vben Admin Naive](https://github.com/Ducr/vue-vben-admin-naive) `5.5.9`版本的文档！这是基于 Vue Vben Admin v5.5.9 独立拆分的 Naive UI 版本单页应用（SPA）。
